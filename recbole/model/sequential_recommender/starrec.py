...
class STARRec(SequentialRecommender):
    def __init__(self, config, dataset):
        ...
        self.MOELayer = MoE(d_model=self.hidden_size, n_experts=8, expert_hidden_size=4 * self.hidden_size,
                            dropout=self.dropout_prob)
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_tensor):
        ...
        attention_scores = (weights[0] * attention_scores + weights[1] * item_sim.unsqueeze(
            1)) / self.sqrt_attention_head_size
